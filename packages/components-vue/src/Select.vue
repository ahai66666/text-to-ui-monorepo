...
const props = defineProps({ modelValue: String, label: { type: String, default: "状态" }, options: { type: Array, default: () => ["进行中", "已完成", "已归档"] }, disabled: Boolean, state: { type: String, default: "default" }, surface: { type: String, default: "white" } });
