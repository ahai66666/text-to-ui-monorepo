...
const runtimeScript = [
  ...
  '  const closeMenus = () => root.querySelectorAll(".tui-button-dropdown__menu, .tui-generated__menu, .tui-generated__panel, .tui-attachment__menu").forEach((menu) => { menu.hidden = true; menu.classList.remove("is-open"); const trigger = menu.previousElementSibling; trigger?.setAttribute("aria-expanded", "false"); });',
